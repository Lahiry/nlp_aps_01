...
def scrape_restaurant_links(page_url):
    ...
    for restaurant in restaurant_list:
        ...
        restaurant_names.append(name.split('.')[1])
...
def scrape_restaurant_reviews(restaurant_url):
    ...
    while restaurant_url and len(restaurant_reviews) < review_limit:
        ...
        print("RESTAURANT REVIEWS LENGTH: ", len(restaurant_reviews))
        ...
        if next_page and 'href' in next_page.attrs:
            print("NEXT RESTAURANT REVIEW PAGE: ", next_page['href'])
            restaurant_url = 'https://www.tripadvisor.com.br' + next_page['href']
        else:
            print("NO NEXT RESTAURANT REVIEW PAGE")
            restaurant_url = None
...
def scrape_trip_advisor_restaurants(start_url):
    ...
    while current_url and len(all_restaurants) < max_restaurants:
        ...
        if next_page and 'href' in next_page.attrs:
            print("NEXT RESTAURANT PAGE: ", next_page['href'])
            current_url = 'https://www.tripadvisor.com.br' + next_page['href']
        else:
            print("NO NEXT RESTAURANT PAGE")
            current_url = None
...
data_dir = '../data'
file_path = os.path.join(data_dir, 'trip_advisor_restaurants_sp.csv')
